...
INCLUDE_ASM("st/are/nonmatchings/e_axe_knight", EntityAxeKnightBlue);

INCLUDE_ASM("st/are/nonmatchings/e_axe_knight", EntityAxeKnightRotateAxe);

INCLUDE_ASM("st/are/nonmatchings/e_axe_knight", EntityAxeKnightThrowingAxe);
