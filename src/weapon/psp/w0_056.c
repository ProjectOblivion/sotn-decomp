...
#include <weapon.h>
#define OVL_EXPORT(x) W0_056_##x

INCLUDE_ASM("weapon/w0_056_psp/nonmatchings/psp/w0_056", func_pspeu_092F2E80);

INCLUDE_ASM("weapon/w0_056_psp/nonmatchings/psp/w0_056", LoadWeaponPalette);

INCLUDE_ASM("weapon/w0_056_psp/nonmatchings/psp/w0_056", func_pspeu_092F3000);

INCLUDE_ASM("weapon/w0_056_psp/nonmatchings/psp/w0_056", func_pspeu_092F3048);

INCLUDE_ASM("weapon/w0_056_psp/nonmatchings/psp/w0_056", EntityWeaponAttack);

INCLUDE_ASM("weapon/w0_056_psp/nonmatchings/psp/w0_056", func_ptr_80170004);
