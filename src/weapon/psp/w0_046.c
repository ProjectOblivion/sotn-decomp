...
#include <weapon.h>
#define OVL_EXPORT(x) W0_046_##x

INCLUDE_ASM("weapon/w0_046_psp/nonmatchings/psp/w0_046", func_pspeu_092F2E80);

INCLUDE_ASM("weapon/w0_046_psp/nonmatchings/psp/w0_046", LoadWeaponPalette);

INCLUDE_ASM("weapon/w0_046_psp/nonmatchings/psp/w0_046", func_pspeu_092F3000);

INCLUDE_ASM("weapon/w0_046_psp/nonmatchings/psp/w0_046", func_pspeu_092F3070);

INCLUDE_ASM("weapon/w0_046_psp/nonmatchings/psp/w0_046", EntityWeaponAttack);

INCLUDE_ASM("weapon/w0_046_psp/nonmatchings/psp/w0_046", func_ptr_80170004);
