...
#include <weapon.h>
#define OVL_EXPORT(x) W0_044_##x

INCLUDE_ASM("weapon/w0_044_psp/nonmatchings/psp/w0_044", func_pspeu_092F2E80);

INCLUDE_ASM("weapon/w0_044_psp/nonmatchings/psp/w0_044", LoadWeaponPalette);

INCLUDE_ASM("weapon/w0_044_psp/nonmatchings/psp/w0_044", EntityWeaponAttack);
