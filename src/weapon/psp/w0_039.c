...
#include <weapon.h>
#define OVL_EXPORT(x) W0_039_##x

INCLUDE_ASM("weapon/w0_039_psp/nonmatchings/psp/w0_039", func_pspeu_092F2E80);

INCLUDE_ASM("weapon/w0_039_psp/nonmatchings/psp/w0_039", LoadWeaponPalette);

INCLUDE_ASM("weapon/w0_039_psp/nonmatchings/psp/w0_039", func_pspeu_092F3000);

INCLUDE_ASM("weapon/w0_039_psp/nonmatchings/psp/w0_039", func_pspeu_092F3048);

INCLUDE_ASM("weapon/w0_039_psp/nonmatchings/psp/w0_039", EntityWeaponAttack);

INCLUDE_ASM("weapon/w0_039_psp/nonmatchings/psp/w0_039", func_ptr_80170004);
