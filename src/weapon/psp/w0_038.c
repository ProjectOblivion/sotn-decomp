...
#include <weapon.h>
#define OVL_EXPORT(x) W0_038_##x

INCLUDE_ASM("weapon/w0_038_psp/nonmatchings/psp/w0_038", func_pspeu_092F2E80);

INCLUDE_ASM("weapon/w0_038_psp/nonmatchings/psp/w0_038", LoadWeaponPalette);

INCLUDE_ASM("weapon/w0_038_psp/nonmatchings/psp/w0_038", func_pspeu_092F3000);

INCLUDE_ASM("weapon/w0_038_psp/nonmatchings/psp/w0_038", func_pspeu_092F3048);

INCLUDE_ASM("weapon/w0_038_psp/nonmatchings/psp/w0_038", EntityWeaponAttack);

INCLUDE_ASM("weapon/w0_038_psp/nonmatchings/psp/w0_038", func_ptr_80170004);
