...
#include <weapon.h>
#define OVL_EXPORT(x) W1_046_##x

INCLUDE_ASM("weapon/w1_046_psp/nonmatchings/psp/w1_046", func_pspeu_092F6C80);

INCLUDE_ASM("weapon/w1_046_psp/nonmatchings/psp/w1_046", LoadWeaponPalette);

INCLUDE_ASM("weapon/w1_046_psp/nonmatchings/psp/w1_046", func_pspeu_092F6E00);

INCLUDE_ASM("weapon/w1_046_psp/nonmatchings/psp/w1_046", func_pspeu_092F6E70);

INCLUDE_ASM("weapon/w1_046_psp/nonmatchings/psp/w1_046", EntityWeaponAttack);

INCLUDE_ASM("weapon/w1_046_psp/nonmatchings/psp/w1_046", func_ptr_80170004);
