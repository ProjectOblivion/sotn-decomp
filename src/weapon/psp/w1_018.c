...
#include <weapon.h>
#define OVL_EXPORT(x) W1_018_##x

INCLUDE_ASM("weapon/w1_018_psp/nonmatchings/psp/w1_018", func_pspeu_092F6C80);

INCLUDE_ASM("weapon/w1_018_psp/nonmatchings/psp/w1_018", LoadWeaponPalette);

INCLUDE_ASM("weapon/w1_018_psp/nonmatchings/psp/w1_018", func_pspeu_092F6E00);

INCLUDE_ASM("weapon/w1_018_psp/nonmatchings/psp/w1_018", func_pspeu_092F6E48);

INCLUDE_ASM("weapon/w1_018_psp/nonmatchings/psp/w1_018", EntityWeaponAttack);

INCLUDE_ASM("weapon/w1_018_psp/nonmatchings/psp/w1_018", func_ptr_80170004);
