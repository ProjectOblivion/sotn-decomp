...
#include <weapon.h>
#define OVL_EXPORT(x) W1_038_##x

INCLUDE_ASM("weapon/w1_038_psp/nonmatchings/psp/w1_038", func_pspeu_092F6C80);

INCLUDE_ASM("weapon/w1_038_psp/nonmatchings/psp/w1_038", LoadWeaponPalette);

INCLUDE_ASM("weapon/w1_038_psp/nonmatchings/psp/w1_038", func_pspeu_092F6E00);

INCLUDE_ASM("weapon/w1_038_psp/nonmatchings/psp/w1_038", func_pspeu_092F6E48);

INCLUDE_ASM("weapon/w1_038_psp/nonmatchings/psp/w1_038", EntityWeaponAttack);

INCLUDE_ASM("weapon/w1_038_psp/nonmatchings/psp/w1_038", func_ptr_80170004);
