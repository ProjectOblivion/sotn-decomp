...
#include <weapon.h>
#define OVL_EXPORT(x) W1_039_##x

INCLUDE_ASM("weapon/w1_039_psp/nonmatchings/psp/w1_039", func_pspeu_092F6C80);

INCLUDE_ASM("weapon/w1_039_psp/nonmatchings/psp/w1_039", LoadWeaponPalette);

INCLUDE_ASM("weapon/w1_039_psp/nonmatchings/psp/w1_039", func_pspeu_092F6E00);

INCLUDE_ASM("weapon/w1_039_psp/nonmatchings/psp/w1_039", func_pspeu_092F6E48);

INCLUDE_ASM("weapon/w1_039_psp/nonmatchings/psp/w1_039", EntityWeaponAttack);

INCLUDE_ASM("weapon/w1_039_psp/nonmatchings/psp/w1_039", func_ptr_80170004);
