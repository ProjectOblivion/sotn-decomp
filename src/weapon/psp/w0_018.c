...
#include <weapon.h>
#define OVL_EXPORT(x) W0_018_##x

INCLUDE_ASM("weapon/w0_018_psp/nonmatchings/psp/w0_018", func_pspeu_092F2E80);

INCLUDE_ASM("weapon/w0_018_psp/nonmatchings/psp/w0_018", LoadWeaponPalette);

INCLUDE_ASM("weapon/w0_018_psp/nonmatchings/psp/w0_018", func_pspeu_092F3000);

INCLUDE_ASM("weapon/w0_018_psp/nonmatchings/psp/w0_018", func_pspeu_092F3048);

INCLUDE_ASM("weapon/w0_018_psp/nonmatchings/psp/w0_018", EntityWeaponAttack);

INCLUDE_ASM("weapon/w0_018_psp/nonmatchings/psp/w0_018", func_ptr_80170004);
