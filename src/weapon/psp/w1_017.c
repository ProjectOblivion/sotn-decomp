...
#include <weapon.h>
#define OVL_EXPORT(x) W1_017_##x

INCLUDE_ASM("weapon/w1_017_psp/nonmatchings/psp/w1_017", func_pspeu_092F6C80);

INCLUDE_ASM("weapon/w1_017_psp/nonmatchings/psp/w1_017", LoadWeaponPalette);

INCLUDE_ASM("weapon/w1_017_psp/nonmatchings/psp/w1_017", func_pspeu_092F6E00);

INCLUDE_ASM("weapon/w1_017_psp/nonmatchings/psp/w1_017", EntityWeaponAttack);
